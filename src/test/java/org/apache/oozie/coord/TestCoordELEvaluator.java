...
public class TestCoordELEvaluator extends XTestCase {
    ...
    public void testCreateURIELEvaluator() throws Exception {
        ELEvaluator eval = CoordELEvaluator
                .createURIELEvaluator("2009-08-09T23:59-0800");
    ...
    public void testCreateDataEvaluator() throws Exception {
        ...
        jobXml += " action-nominal-time='2009-09-01T00:00-0800' action-actual-time='2010-10-01T00:00-0800'>";
        jobXml += "<input-events><data-in name=\"A\" dataset=\"a\"><uris>file:///tmp/coord/US/2009/1/30|file:///tmp/coord/US/2009/1/31</uris>";
        jobXml += "<dataset name=\"a\" frequency=\"1440\" initial-instance=\"2009-01-01T00:00-0800\">";
        ...
        reply += "<property><name>NOMINALTIME</name><value>2009-09-01T00:00-0800</value></property>";
        reply += "<property><name>ACTUALTIME</name><value>2010-10-01T00:00-0800</value></property>";
    ...
    public void testCreateInstancesELEvaluator() throws Exception {
        ...
        dataEvntXML += "<dataset name=\"a\" frequency=\"1440\" initial-instance=\"2009-01-01T00:00-0800\" freq_timeunit=\"MINUTE\" timezone=\"UTC\" end_of_duration=\"NONE\">";
        ...
        appInst.setNominalTime(DateUtils.parseDateOozieTZ("2009-09-08T01:00-0800"));
        appInst.setActualTime(DateUtils.parseDateOozieTZ("2010-10-01T00:00-0800"));
        ...
        // System.out.println("OUTPUT :" + eval.evaluate(expr, String.class));
        assertEquals("2009-09-08T00:00-0800", eval.evaluate(expr, String.class));
    }
    ...
    public void testCreateLazyEvaluator() throws Exception {
        ...
        Date actualTime = DateUtils.parseDateOozieTZ("2009-09-01T01:00-0800");
        Date nominalTime = DateUtils.parseDateOozieTZ("2009-09-01T00:00-0800");
        ...
        assertEquals("2009-01-02T00:00-0800 ${coord:latest(-1)}", eval.evaluate(expr, String.class));

        // future
        createTestCaseSubDir("2009/09/04/_SUCCESS".split("/"));
        createTestCaseSubDir("2009/09/05/_SUCCESS".split("/"));
        expr = "${coord:future(1, 30)}";
        assertEquals("2009-09-05T00:00-0800", eval.evaluate(expr, String.class));
